...
Tell each agent: "First read the PR/issue context, any `CLAUDE.md`/`AGENTS.md`, and the files neighboring the diff, then review the diff for [their lens]. Your final message is your whole report: put every finding in it, and do not send anything after it."
